...
{
    BSTNode<Data>* findSucc = this;
    BSTNode<Data>* curr = this;
    
    
    if (this->right != nullptr) {
        findSucc = this->right;
        while (findSucc->left != nullptr) {
            findSucc = findSucc->left;
        }
        return findSucc;
    }
    
    else {
        while (findSucc != nullptr) {
            //findSucc = findSucc->parent;
            if (findSucc->right != NULL && findSucc->right == curr) {
                curr = findSucc;
            }
            
            if (findSucc->left != NULL && findSucc->left == curr) {
                return findSucc;
            }
