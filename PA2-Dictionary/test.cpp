...
int main(int argc, char** argv)
{
    ...
    scTrie.insert("stop"    ,9100);
    scTrie.insert("stom"    ,101);
    scTrie.insert("stor"    ,102);
    scTrie.insert("qtoo"    ,103);
    scTrie.insert("stao"    ,103);
    scTrie.insert("stoe"    ,103);
    ...
    Timer time;
    time.begin_timer();
    //SuffixArray* s = new SuffixArray("hello");
    SuffixArray s("word");
    cout << time.end_timer() << endl;
    //s.find("ord");
